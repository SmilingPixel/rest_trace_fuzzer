...
func ParseCmdArgs() {
	...
	flag.IntVar(&GlobalConfig.HTTPClientDialTimeout, "http-client-dial-timeout", 30, "Timeout for the HTTP client dial, in seconds.")
	...
	flag.StringVar(&GlobalConfig.InternalServiceAPIDependencyFilePath, "internal-service-api-dependency-file", "", "Path to the internal service API dependency file generated by other tools or manually")
